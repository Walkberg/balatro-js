        ...
        <div className={cn("relative", { "-translate-y-4 z-20": selected })}>
          ...
          <div className="flex flex-row items-center">
            <div className="flex flex-col items-center">
              ...
              <BuffonCardRender buffon={buffon} onClick={onClick} />
              {selected && (
...
interface BuffonCardRenderProps {
  buffon: Buffon;
  onClick?: () => void;
}

export const BuffonCardRender = ({
  buffon,
  onClick,
}: BuffonCardRenderProps) => {
